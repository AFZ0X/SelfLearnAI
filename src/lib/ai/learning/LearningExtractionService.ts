...
const EXTRACTION_PATTERNS = [
  ...
  { pattern: /أنا\s+عمري\s+(\d+)/i, tag: "age", confidence: 0.9 },
  { pattern: /عمري\s+هو\s+(\d+)/i, tag: "age", confidence: 0.95 },
  { pattern: /عمري\s+(\d+)/i, tag: "age", confidence: 0.95 },
  { pattern: /اقولك\s+عمري\s+(?:هو\s+)?(\d+)/i, tag: "age", confidence: 0.9 },
  { pattern: /i(?:'| a)?m\s+(\d+)\s*(?:years?\s*old|y\.?o\.?)/i, tag: "age", confidence: 0.95 },
  { pattern: /my age is\s+(\d+)/i, tag: "age", confidence: 0.95 },
  { pattern: /أنا\s+(.+)/i, tag: "user_info", confidence: 0.7 },
  { pattern: /ساكن\s+في\s+(.+)/i, tag: "location", confidence: 0.9 },
  { pattern: /أنا\s+من\s+(.+)/i, tag: "location", confidence: 0.8 },
  { pattern: /أسكن\s+في\s+(.+)/i, tag: "location", confidence: 0.9 },
  { pattern: /i (?:like|love|enjoy) (\w+)/i, tag: "preference", confidence: 0.7 },
  { pattern: /أحب\s+(.+)/i, tag: "preference", confidence: 0.85 },
  { pattern: /أعشق\s+(.+)/i, tag: "preference", confidence: 0.8 },
  { pattern: /أفضل\s+(.+)/i, tag: "preference", confidence: 0.8 },
  { pattern: /i (?:work|works|job) (?:as|at|for) (.+)/i, tag: "work", confidence: 0.8 },
  { pattern: /أشتغل\s+(?:في|بـ|كـ)\s+(.+)/i, tag: "work", confidence: 0.85 },
  { pattern: /أدرس\s+(.+)/i, tag: "education", confidence: 0.85 },
  { pattern: /i study\s+(.+)/i, tag: "education", confidence: 0.85 },
  ...
  { pattern: /أستخدم\s+(.+)/i, tag: "tool", confidence: 0.75 },
  { pattern: /i (?:need|needs|wants?) (\w+)/i, tag: "goal", confidence: 0.6 },
  { pattern: /هدفي\s+(\S+(?:\s+\S+){0,10})/i, tag: "goal", confidence: 0.9 },
  { pattern: /i want to\s+(.+)/i, tag: "goal", confidence: 0.7 },
